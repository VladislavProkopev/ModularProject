...
struct FCoreAbilityTagRelationship
{
	...
	UPROPERTY(EditAnywhere,Category=Ability,meta = (Categories = "Abilities"))
 ...
 */
UCLASS()
class COREGAS_API UCoreAbilityTagRelationshipMapping : public UPrimaryDataAsset
{
	GENERATED_BODY()
private:
...
public:
	...
	void GiveRequiredAbdBlockedActivationTags(const FGameplayTagContainer& AbilityTags, FGameplayTagContainer* OutActivationRequired, FGameplayTagContainer* OutActivationBlocked) const;
